...
void DessinePacMan(int l, int c, int dir)
{
    ...
    {
    case DROITE:
        DessineSprite(l, c, S_PACMAN_DROITE);
        break;
    case GAUCHE:
        DessineSprite(l, c, S_PACMAN_GAUCHE);
        break;
    case HAUT:
        DessineSprite(l, c, S_PACMAN_HAUT);
        break;
    case BAS:
        DessineSprite(l, c, S_PACMAN_BAS);
        break;
    default:
        DessineSprite(l, c, S_PACMAN_DROITE);
        break;
...
void DessineFantome(int l, int c, int couleur, int dir)
{
    ...
    case DROITE:
        if (couleur == ROUGE)
            DessineSprite(l, c, S_FANTOME_ROUGE_DROITE);
        else if (couleur == MAUVE)
            DessineSprite(l, c, S_FANTOME_MAUVE_DROITE);
        else if (couleur == VERT)
            DessineSprite(l, c, S_FANTOME_VERT_DROITE);
        else if (couleur == ORANGE)
            DessineSprite(l, c, S_FANTOME_ORANGE_DROITE);
        else
            DessineSprite(l, c, S_FANTOME_ROUGE_DROITE);
        break;
    case GAUCHE:
        if (couleur == ROUGE)
            DessineSprite(l, c, S_FANTOME_ROUGE_GAUCHE);
        else if (couleur == MAUVE)
            DessineSprite(l, c, S_FANTOME_MAUVE_GAUCHE);
        else if (couleur == VERT)
            DessineSprite(l, c, S_FANTOME_VERT_GAUCHE);
        else if (couleur == ORANGE)
            DessineSprite(l, c, S_FANTOME_ORANGE_GAUCHE);
        else
            DessineSprite(l, c, S_FANTOME_ROUGE_GAUCHE);
        break;
    case HAUT:
        if (couleur == ROUGE)
            DessineSprite(l, c, S_FANTOME_ROUGE_HAUT);
        else if (couleur == MAUVE)
            DessineSprite(l, c, S_FANTOME_MAUVE_HAUT);
        else if (couleur == VERT)
            DessineSprite(l, c, S_FANTOME_VERT_HAUT);
        else if (couleur == ORANGE)
            DessineSprite(l, c, S_FANTOME_ORANGE_HAUT);
        else
            DessineSprite(l, c, S_FANTOME_ROUGE_HAUT);
        break;
    case BAS:
        if (couleur == ROUGE)
            DessineSprite(l, c, S_FANTOME_ROUGE_BAS);
        else if (couleur == MAUVE)
            DessineSprite(l, c, S_FANTOME_MAUVE_BAS);
        else if (couleur == VERT)
            DessineSprite(l, c, S_FANTOME_VERT_BAS);
        else if (couleur == ORANGE)
            DessineSprite(l, c, S_FANTOME_ORANGE_BAS);
        else
            DessineSprite(l, c, S_FANTOME_ROUGE_BAS);
        break;
    default:
...
void DessineChiffre(int l, int c, int val)
{
    ...
    {
    case 0:
        DessineSprite(l, c, S_CHIFFRE_0);
        break;
    case 1:
        DessineSprite(l, c, S_CHIFFRE_1);
        break;
    case 2:
        DessineSprite(l, c, S_CHIFFRE_2);
        break;
    case 3:
        DessineSprite(l, c, S_CHIFFRE_3);
        break;
    case 4:
        DessineSprite(l, c, S_CHIFFRE_4);
        break;
    case 5:
        DessineSprite(l, c, S_CHIFFRE_5);
        break;
    case 6:
        DessineSprite(l, c, S_CHIFFRE_6);
        break;
    case 7:
        DessineSprite(l, c, S_CHIFFRE_7);
        break;
    case 8:
        DessineSprite(l, c, S_CHIFFRE_8);
        break;
    case 9:
        DessineSprite(l, c, S_CHIFFRE_9);
        break;
    default:
        DessineSprite(l, c, S_CHIFFRE_0);
        break;
